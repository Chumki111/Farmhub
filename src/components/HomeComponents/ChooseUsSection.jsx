      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="relative mt-6 lg:mt-0">
            ...
            <img src={lFood} alt="Left Food" className="absolute top-0 left-28 transform md:-translate-x-8 w-16 md:w-32" />
            <img src={fFood} alt="First Food" className="absolute bottom-40  transform md:-translate-x-8 w-16 md:w-40" />
            <img src={tFood} alt="Third Food" className="absolute bottom-4 left-20 transform md:translate-y-6 w-16 md:w-36" />

          </div>
          {/* content section */}
          <div className="order-first lg:order-last">
            <span className='text-secondary text-lg font-medium'>Why Chose Us</span>
            <h1 className='text-4xl md:text-4xl lg:text-6xl font-semibold md:leading-[85px] pt-4 text-primary'>Bringing nature's <br /> bounty to your plate</h1>
